...
WALLET_ROOT=$$PWD/ditcoin

CONFIG += c++11

# cleaning "auto-generated" ditcoin directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently ditcoin has an issue with "static" build and linunwind-dev,
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libditcoin-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
